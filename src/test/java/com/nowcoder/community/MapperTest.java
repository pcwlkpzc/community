...
@ContextConfiguration(classes = CommunityApplication.class)//指定启动器
public class MapperTest {
    ...
    public void testSelectPosts(){
        ...
        int rows = discussPostMapper.selectDiscussPostRows(0);//查询所有记录
        System.out.println(rows);
        rows = discussPostMapper.selectDiscussPostRows(101);//查询101用户的所有帖子数量
        System.out.println(rows);
    }
    ...
    public void testSelectLetters(){
        ...
        int i = messageMapper.selectLettersCount("111_112");
